   ...
   <div className='home' id='home'>
      <div className='home-left'>     
        <div className='home-name'>
           ...
           <p>Profesora de inglés y estudiante de programación con ganas de especializarme en desarrollo Frontend. Generar nuevos aprendizajes nos abre la mente y nos ayuda a crecer, por eso disfruto tanto de formar parte de ese proceso, tanto de un lado como del otro. Amo enseñar así como aprender y, en este camino de descubrimiento, decidí emprender una nueva carrera.   </p>
        </div>
